...
#include "UnrealNetwork.h"
	...
	// *** Basic Functionality ***
	//
bool USInventoryBase::Initialize(int32 inSlots, TArray<FInventoryStructure> & inInventory) {
...
bool USInventoryBase::GetStackByClass(TSubclassOf<class ASUsableActor> inClass, bool bReturnFullStacks, TArray<FInventoryStructure> inInventory, FInventoryStructure & outStructure, int32 & FoundIndex) {
...
bool USInventoryBase::GetItemCount(TSubclassOf<class ASUsableActor> inClass, TArray<FInventoryStructure> inInventory, int32 & ItemCount) {
	int32 intCounter = 0;
...
bool USInventoryBase::GetItemStackCount(TSubclassOf<class ASUsableActor> inClass, TArray<FInventoryStructure> inInventory, int32 & StackCount) {
	int32 intCounter = 0;
...
bool USInventoryBase::GetStackByIndex(int32 inIndex, TArray<FInventoryStructure> inInventory, FInventoryStructure & outStructure) {
...
bool USInventoryBase::GetStackByID(FString inID, TArray<FInventoryStructure> inInventory, FInventoryStructure & outStructure, int32 & FoundIndex) {
...
bool USInventoryBase::GetFreeInventorySpace(TSubclassOf<class ASUsableActor> inClass, TArray<FInventoryStructure> inInventory, int32 & outCount) {
...
bool USInventoryBase::GetFreeInventorySlots(TArray<FInventoryStructure> inInventory, int32 & outCount) {
	int32 intCounter = 0;
...
//
bool USInventoryBase::GetItemInfo(TSubclassOf<ASUsableActor> bItemClass, FItemData & bIteminfo) {
...
//
void USInventoryBase::GetUniqueID(FString & bUniqueID) {
	bUniqueID = FString();
...
int32 USInventoryBase::StacksFromAmount(TSubclassOf<class ASUsableActor> inClass, int32 inAmount) {
	FItemData bItemInfo;
	GetItemInfo(inClass, bItemInfo);
...
bool USInventoryBase::AddToInventory(TSubclassOf<class ASUsableActor> inClass, TArray<FInventoryStructure>& inInventory, int32 Amount, bool AddNewStack) {
	bool result;
	FItemData bItemInfo;
	int32 FoundStack = -1;
...
bool USInventoryBase::RemoveFromInventory(TSubclassOf<class ASUsableActor> inClass, TArray<FInventoryStructure>& inInventory, int32 Amount) {
...
bool USInventoryBase::RemoveFromStack(int32 inIndex, TArray<FInventoryStructure>& inInventory, int32 Amount, bool RemoveWholeStack) {
	FInventoryStructure bInventoryStructure;
...
bool USInventoryBase::SwapInventoryPosition(TArray<FInventoryStructure>& inInventory, int32 inIndexA, int32 inIndexB) {
	FInventoryStructure bInventoryStructure;
...
bool USInventoryBase::SplitStack(TArray<FInventoryStructure>& inInventory, int32 inIndex, int32 inSplit) {
	FInventoryStructure bInventoryStructure;
...
bool USInventoryBase::MergeStacks(TArray<FInventoryStructure>& inInventory, int32 inIndexA, int32 inIndexB) {
	FItemData bItemInfo;
